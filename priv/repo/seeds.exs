...
%Flight{
  ...
  origin: "DEN",
  destination: "ORD",
  departure_time: Helper.get_datetime([days: 1]),
  arrival_time: Helper.get_datetime([days: 1, hours: 2])
}
|> Repo.insert!()
...
origin: "DEN",
destination: "ORD",
departure_time: Helper.get_datetime([days: 2]),
arrival_time: Helper.get_datetime([days: 2, hours: 2])
}
|> Repo.insert!()
...
origin: "DEN",
destination: "ORD",
departure_time: Helper.get_datetime([days: 3]),
arrival_time: Helper.get_datetime([days: 3, hours: 2])
}
|> Repo.insert!()
...
destination: "ORD",
departure_time: Helper.get_datetime([days: 1]),
arrival_time: Helper.get_datetime([days: 1, hours: 4])
}
|> Repo.insert!()
...
destination: "ORD",
departure_time: Helper.get_datetime([days:  2]),
arrival_time: Helper.get_datetime([days: 2, hours: 4])
}
|> Repo.insert!()
...
destination: "ORD",
departure_time: Helper.get_datetime([days: 3]),
arrival_time: Helper.get_datetime([days: 3, hours: 4])
}
|> Repo.insert!()
